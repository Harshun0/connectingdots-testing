                  ...
                  >
                    ...
                    >
                      {[...logos, ...logos].map((src, index) => (
                        <div
                          key={`${idx}-${index}`}
                          className="bg-white rounded-lg shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl hover:scale-105 h-20 w-full overflow-hidden"
                        >
                          <img
                            src={src}
