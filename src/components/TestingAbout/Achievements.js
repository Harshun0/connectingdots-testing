...
// Hoist static data outside component to avoid re-creation on each render
...
const AchievementsSection = () => {
  const topAchievements = TOP_ACHIEVEMENTS;
  const bottomAchievements = BOTTOM_ACHIEVEMENTS;
  ...
  return (
    ...
    >
      {/* Background pattern overlay - matching Keypoints.js exactly */}
      <div 
        ...
        <div className="flex flex-col lg:flex-row items-start gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="flex-1 w-full">
            ...
            <div className="mb-4 sm:mb-6 lg:mb-8 mt-2 sm:mt-4">
              <div className="relative h-20 sm:h-24 lg:h-32 overflow-hidden" style={{ willChange: 'transform' }}>
